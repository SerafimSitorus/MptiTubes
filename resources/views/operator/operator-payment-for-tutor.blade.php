...
<div class="my-4 w-full px-4 md:px-10 overflow-auto">
  <div class="flex justify-between md:items-end flex-col md:flex-row">
      <div>
          ...
          <h2 class="mt-6 text-lg lg:text-xl font-semibold">For Tutor</h2>
      </div>
      ...
      <table class="min-w-full  border border-gray-200">
          <thead class="bg-blue-800">
              <tr>
                  ...
                  <th class="text-white text-left px-3 py-1 lg:px-10 lg:py-3">City</th>
          ...
          <tbody>
              <tr class="border border-yellow-500">
                  ...
                  <td class="px-3 py-1 lg:px-10 lg:py-3 text-left">Binjai</td>
                  ...
                  <td class="px-3 py-1 lg:px-10 lg:py-3 text-left"><a href="operator-payment-for-tutor-detail" class="underline text-blue-700">See details</a></td>
              </tr>
              <tr class="border border-yellow-500">
              ...
              <tr class="border border-yellow-500">
                  ...
                  <td class="px-3 py-1 lg:px-10 lg:py-3 text-left">Medan</td>
                  <td class="px-3 py-1 lg:px-10 lg:py-3 text-left">1 January 2024</td>
                  <td class="px-3 py-1 lg:px-10 lg:py-3 text-left">
                      <p class="py-2 px-2 rounded-md text-sm bg-green-300 text-black text-center">Completed</p>
                  </td>
