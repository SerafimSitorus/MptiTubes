...
@section('title', 'Operator - Edit Password') 
...
<div class="flex flex-col p-4">
    ...
    <div class="max-w-2xl mx-auto bg-white p-12 rounded-lg shadow-lg">
        ...
        <form id="passwordForm" action="operator-profil-edit-password-insert" method="post">
            @csrf
            <div class="mb-6">
            ...
            <div class="mt-8 flex justify-center space-x-4">
                ...
                <a href="dashboard" class="px-8 py-4 bg-gray-600 text-white rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 text-lg font-bold">kembali</a>
            </div>
        </form>
    </div>
</div>
