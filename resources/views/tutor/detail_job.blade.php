...
@section('title','Tutor - Detail Job')

@section('content')

<div class="container mx-auto p-4">
    <div class="mb-8 text-center">
        <h1 class="text-2xl lg:text-4xl font-bold">Informasi Lowongan</h1>
    </div>
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                <label class="block text-lg font-medium text-gray-700">Kontak</label>
                <p class="text-lg">{{ $data->kontak }}</p>
            </div>
            <div>
        ...
        <div class="mt-8 flex justify-center space-x-4">
            <a href="{{ route('tutor.lamar', ['id_lowongan' => $data->id]) }}" class="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-lg font-bold">Submit</a>
