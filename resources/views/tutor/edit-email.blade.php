...
<div class="flex flex-col p-4">
    ...
    <div class="max-w-2xl mx-auto  p-12 rounded-lg shadow-lg">
        <form action="#" method="post">
            <div class="mb-6">
                <label for="current_email" class="block text-lg font-medium ">Current Email</label>
            ...
            <div class="mb-6">
                <label for="new_email" class="block text-lg font-medium ">New Email</label>
