<nav class="bg-[#001840] mx-auto w-full py-4 px-8">
  ...
  <div id="navbar-menu" class="bg-[#001840] text-white py-4 px-8 md:hidden -translate-y-full duration-500 transition-all z-50 fixed top-0 left-0 right-0 max-h-96 overflow-y-auto">
    ...
    <ul class="flex flex-col gap-4 mt-16">
        <li><a href="tutor-profil" class="flex justify-between items-center py-2 text-lg">Profil <span>&rarr;</span></a></li>
        <li><a href="tutordashboard" class="flex justify-between items-center py-2 text-lg">Dashboard <span>&rarr;</span></a></li>
        <li><a href="tutor-alljob" class="flex justify-between items-center py-2 text-lg">All Job <span>&rarr;</span></a></li>
        <li><a href="tutor-history" class="flex justify-between items-center py-2 text-lg">Tutor History <span>&rarr;</span></a></li>
        <li><a href="tutorschedule" class="flex justify-between items-center py-2 text-lg">Tutor Schedule <span>&rarr;</span></a></li>
        <li><a href="tutorpayment" class="flex justify-between items-center py-2 text-lg">Pembayaran <span>&rarr;</span></a></li>
