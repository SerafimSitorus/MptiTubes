...
<div class="flex my-4 items-start">
    <div id="sidebar-parent" class="w-28 md:block hidden md:w-80 h-full -translate-x-full transition-all bg-yellow-200 rounded-xl md:py-8 py-2 px-2 md:px-4 gap-4">
        <a href="dashboard" class=" flex items-center gap-3 px-4 py-2 hover:bg-yellow-100 rounded-md {{request()->is('tutor/dashboard') ? 'bg-yellow-100' : ''}}">
            <img src="{{ asset('images/image-3.svg') }}" alt="home"/>
            <span class="text-black text-base hidden md:block">Dashboard</span>
        </a>
        <a href="tutor-alljob" class=" flex items-center gap-3 px-4 py-2 hover:bg-yellow-100 rounded-md {{request()->is('tutor/tutor-alljob') ? 'bg-yellow-100' : ''}}">
            <img src="{{ asset('images/image-4.svg') }}" alt="home"/>
            <span class="text-black text-base hidden md:block">All Job</span>
        </a>
        <a href="tutor-history" class=" flex items-center gap-3 px-4 py-2 hover:bg-yellow-100 rounded-md {{request()->is('tutor/tutor-history') ? 'bg-yellow-100' : ''}}">
        ...
        <a href="tutorschedule" class=" flex items-center gap-3 px-4 py-2 hover:bg-yellow-100 rounded-md {{request()->is('tutor/tutorschedule') ? 'bg-yellow-100' : ''}}">
            <img src="{{ asset('images/calendar.png') }}" alt="home" class=" w-7 h-7" alt="Schedule"/>
            <span class="text-black text-base hidden md:block">Schedule</span>
        </a>
        <a href="tutor-profil" class="flex items-center gap-3 px-4 py-2 hover:bg-yellow-100 rounded-md {{request()->is('tutor-profil') ? 'bg-yellow-100' : ''}}">
