...
<div class="flex flex-col p-4">
    ...
    <div class="max-w-2xl mx-auto bg-white p-12 rounded-lg shadow-lg">
        ...
        <form id="passwordForm" action="insertupdatepassword" method="post">
            @csrf
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <button type="button"
                        ...
                        <svg id="current_password_icon" class="h-6 w-6 text-gray-700" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path id="eye-icon" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm-3 3a5 5 0 1 0 0-10 5 5 0 0 0 0 10z" />
                        </svg>
                    </button>
                </div>
            </div>
            ...
            <div class="mb-6">
                <label for="confirm_password" class="block text-lg font-medium text-gray-700">Confirm New
                    Password</label>
            ...
            <div class="mt-8 flex justify-center space-x-4">
                <button type="submit"
                    class="px-8 py-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-lg font-bold">Submit</button>
                <a href="tutor-profil"
