...
<head>
  ...
  // Tambahkan atau hapus kelas dark-mode dari section Tentang Kami dan Testimonials
  const aboutSection = document.querySelector('.bg-white.border-b.py-8:nth-of-type(1)');
  const testimonialsSection = document.querySelector('.bg-white.border-b.py-8:nth-of-type(2)');
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
  {{-- <nav class="bg-[#001840] mx-auto w-full py-4 px-8">
    <div class="container flex justify-between w-full items-center">
        ...
        <div class="hidden md:block justify-center items-center space-x-6">
            ...
            <a href="#" class="content-center text-white font-bold no-underline hover:text-yellow-500 py-2 px-4">Tentang Kami</a>
            <a href="#" class="content-center text-white font-bold no-underline hover:text-yellow-500 py-2 px-4">Kontak</a>
        </div>
...
<nav class="bg-[#001840] mx-auto w-full py-4 px-8">
    ...
    @endif
      <div class="flex items-center gap-3 ">
          ...
          <div class="relative text-left md:block hidden">
            <div>
              <button type="button" class="hidden w-full justify-center gap-x-3 items-center rounded-md px-3 py-2 text-sm font-semibold text-white hover:bg-white/10" id="menu-button" aria-expanded="true" aria-haspopup="true">
  ...
  <div id="navbar-menu" class="bg-[#001840] text-white py-4 px-8 md:hidden -translate-y-full duration-500 transition-all z-50 fixed top-0 left-0 right-0 max-h-96 overflow-y-auto">
    ...
    <section class="container mx-auto flex flex-col md:flex-row items-center py-16 md:py-18">
      <div class="flex flex-col w-full md:w-1/2 justify-center items-start text-center md:text-left">
        
          <h1 class="my-4 text-5xl font-bold leading-tight">
              Selamat Datang di Private Tutor Indonesia
          </h1>
          <p class="leading-normal text-2xl mb-8 ml-9">
              Temukan guru privat sesuai kebutuhan pendidikan kamu.
          </p>
          @if (Route::has('login'))
          @auth
          @else
          <a href="{{ route('login') }}" class="mx-auto lg:mx-0 hover:underline bg-white text-blue-900 font-bold rounded-full py-4 px-8 shadow-lg">Mulai Sekarang</a>
          @endif
          @endauth
      ...
      <div class="w-full md:w-1/2 py-6 text-center">
          <img src="{{ ('images/hero.png') }}" class="w-full md:w-4/5 z-50" alt="Hero Image"/>
      </div>
  </section>
      ...
      <section id="tentang-kami" class="bg-white border-b py-8">
          ...
          <div class="flex flex-wrap">
            <div class="w-full sm:w-1/2 p-6 text-center">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Sebagai perantara bagi orang tua dengan guru les private
              </h3>
              <p class="text-gray-600 mb-8">
                Kami akan menghubungkan orang tua dengan guru les private sesuai dengan kriteria yang diberikan
                <br />
            ...
            <div class="w-full sm:w-1/2 p-6 mt-6">
              <div class="align-middle text-center">
                ...
                <p class="text-gray-600 mb-8">
                  Kami memastikan penyediaan guru les privat yang berkualitas tersebar secara merata di Indonesia
                  <br />
                  
                  <img src="{{ ('images/map.png') }}" alt="home" class="mx-auto"/>
            ...
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="w-full font-bold text-xl text-gray-800 px-6">
                  Pencarian guru les privat menjadi lebih mudah
                </div>
                <p class="text-gray-800 text-base px-6 mb-5">
                  Sebelum menggunakan website ini, saya harus bertanya kepada semua kenalan saya untuk mencari guru les privat yang sesuai. Namun, sekarang saya hanya perlu memasukkan kriteria guru les yang saya inginkan dan mendapatkan guru les kurang dari seminggu.
                </p>
              </a>
            </div>
          ...
          <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="w-full font-bold text-xl text-gray-800 px-6">
                  Website sangat mudah digunakan
                </div>
                <p class="text-gray-800 text-base px-6 mb-5">
                  Bagi orang tua seperti saya, website ini tergolong mudah digunakan, saya dapat memahami semua menu tanpa harus bertanya kepada orang lain dan merasa bingung
                </p>
              </a>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
          ...
          <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="w-full font-bold text-xl text-gray-800 px-6">
                  Guru les privat yang ditawarkan memiliki kinerja yang sangat baik
                </div>
                <p class="text-gray-800 text-base px-6 mb-5">
                  Sejak diajar oleh guru les privat dari lembaga les ini, anak saya selalu mendapatkan nilai yang baik dan menjadi lebih cepat tanggap dalam belajar
                </p>
              </a>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
     ...
     <!-- Change the colour #f8fafc to match the previous section colour -->
      ...
      <section class="container mx-auto text-center py-6 mb-12">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
          Ayo temukan tutor kamu bersama kami
        </h1>
        <div class="w-full mb-4">
