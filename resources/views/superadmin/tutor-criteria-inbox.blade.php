...
<div class="my-4 w-full px-4 lg:px-20 overflow-auto">
  <div class="flex justify-between md:items-end flex-col md:flex-row">
      ...
      <h1 class="mt-6 text-lg lg:text-xl font-semibold"></h1>
  </div>
      ...
      <table class="min-w-full  border border-gray-200">
          <thead class="bg-blue-800">
              <tr>
                  ...
                  <th class="text-white text-left px-3 lg:px-10 py-1 lg:py-3">Provinsi</th>
          ...
          <tbody>
            ...
            <tr class="border border-yellow-500">
                ...
                <td class="px-3 py-1 lg:px-10 lg:py-3 text-left">{{ $data->provinsi }}</td>
                <td class="px-3 py-1 lg:px-10 lg:py-3 text-left"><a href="{{ route('superadmin/tutor-criteria/detail', ['id_lowongan' => $data->id]) }}" class="underline text-blue-700">See details</a></td>
                ...
                <td class="px-3 py-1 lg:px-10 lg:py-3 text-left">
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('superadmin/tutor-criteria/detail/tolak', ['id_lowongan' => $data->id]) }}" class="py-1 px-3 bg-red-500 border text-white rounded-md hover:bg-red-700">Tolak</a>
                        @endif
