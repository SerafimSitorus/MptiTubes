...
<div class="my-4 w-full mr-10 lg:mr-20 overflow-auto">
    <div class="flex justify-between md:items-end md:flex-row flex-col">
        <div>
            <h1 class="text-xl lg:text-3xl font-bold">Dashboard</h1>
            <p class="text-sm lg:text-base">You can see all activities here</p>

            <h2 class="mt-6 text-lg lg:text-xl font-semibold">All Activity</h2>
        </div>
    </div>
    <table class="mt-6 w-full">
        <thead class="bg-blue-800 rounded-xl border border-blue-800">
            <tr class="rounded-md">
                ...
                <th class="text-white text-center px-3 lg:px-10 py-1 lg:py-3">Activity</th>
            </tr>
        </thead>
        <tbody>
            <tr class="border border-yellow-500">
                ...
                <td class="lg:px-10 px-3 py-1 lg:py-3 text-center">
                    <div class="flex-container">
                        <button
                            class="py-1 px-3 bg-white border-blue-800 text-black border rounded-md">Active</button>
                    </div>
                </td>
            </tr>
            <tr class="border border-yellow-500">
                ...
                <td class="lg:px-10 px-3 py-1 lg:py-3 text-center">
                    <div class="flex-container">
                        <button class="py-1 px-3 bg-white border-blue-800 border text-black rounded-md">Active
                        </button>
                    </div>
                </td>
            </tr>
