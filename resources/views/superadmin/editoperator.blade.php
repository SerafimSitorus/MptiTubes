...
<div class="my-4 w-full px-4 lg:px-20">
    <div class="flex justify-between items-end mb-4">
        <div>
            <h1 class="text-xl lg:text-3xl font-bold">Edit Operator</h1>
            <p class="text-sm lg:text-base">Kamu dapat mengedit detail dari operator pada halaman ini</p>
        </div>
    </div>
        ...
        <form action="{{route('superadmin/operator/update', ['id'=>$operator->nik])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="user_id" name="user_id" class="input-field" style="color:grey;" value="{{ $operator->user_id}}" readonly>
                </div>
            ...
            -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nik" name="nik" class="input-field" style="color:grey;" value="{{$operator->nik}}" readonly>
                </div>

                <!-- Operator Name -->
                <div class="form-group">
                    <label for="nama_operator" class="label" style="color: black;">Nama Operator</label>
                    <input type="text" id="nama_operator" name="nama_operator" class="input-field" style="color:grey;" value="{{$operator->nama_operator}}" readonly>
                </div>

                <!-- Jenis Kelamin -->
                <div class="form-group">
                    <label for="jenis_kelamin" class="label" style="color: black;">Jenis Kelamin</label>
                    <select id="jenis_kelamin" name="jenis_kelamin" class="input-field" style="color:grey;" disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="input-field" style="color:grey;" value="{{$operator->tempat_lahir}}" readonly>
                </div>

                <!-- Tanggal Lahir -->
                <div class="form-group">
                    <label for="tanggal_lahir" class="label" style="color: black;">Tanggal Lahir</label>
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="input-field" style="color:grey;" value="{{$operator->tanggal_lahir}}" placeholder="yyyy-mm-dd" readonly>
                </div>

                <!-- Province -->
                <div class="form-group">
                    <label for="provinsi_naungan" class="label" style="color: black;">Provinsi Naungan</label>
                    <select id="provinsi_naungan" name="provinsi_naungan" class="input-field" style="color:black;" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="alamat_domisili" name="alamat_domisili" class="input-field" style="color:black;" value="{{ $operator->alamat_domisili}}" required>
                </div>

                <!-- Jenjang Pendidikan -->
                <div class="form-group">
                    <label for="jenjang_pendidikan" class="label" style="color: black;">Jenjang Pendidikan</label>
                    <select id="jenjang_pendidikan" name="jenjang_pendidikan" class="input-field" style="color:black;" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="jurusan" name="jurusan" class="input-field" style="color:black;" value="{{$operator->jurusan}}" required>
                </div>

                <!-- Status -->
                <div class="form-group">
                    <label for="status" class="label" style="color: black;">Status</label>
                    <select id="status" name="status" class="input-field" style="color:black;" required>
            ...
            <div class="mt-6 flex justify-end gap-3">
                <button type="button" class="py-2 px-4 rounded-md border border-blue-700 hover:bg-slate-400 text-black">Batal</button>
                <button type="submit" class="py-2 px-4 rounded-md bg-blue-700 text-white hover:bg-blue-600">Edit</button>
            </div>
        </form>
    </div>
</div>
