    ...
    <div class="flex flex-wrap gap-4 justify-center">
        ...
        <div class="max-w-sm w-full sm:w-1/2 md:w-1/3 lg:w-1/4 flex-shrink-0 rounded overflow-hidden shadow-lg">
            ...
            <div class="flex justify-end px-6 pt-4 pb-2">
                <button @click="showModal = true; tutorToBeDismissed = '{{ $item->id_mengajar }}'" class="inline-block bg-red-500 rounded-full px-3 py-1 text-sm font-bold text-black mr-2 mb-2 items-end hover:bg-red-600">Berhentikan</button>
            </div>
        </div>
        @empty
